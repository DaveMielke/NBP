...
public abstract class CharacterUtilities {
  ...
  public final static char CHAR_SOH = 0X0001; // start of heading
  ...
  public final static char CHAR_ACK = 0X0006; // (positive) acknowledge
  public final static char CHAR_BEL = 0X0007; // bell
  public final static char CHAR_BS  = 0X0008; // backspace
  ...
  public final static char CHAR_DC1 = 0X0011; // device control 1 (X-on)
  public final static char CHAR_DC2 = 0X0012; // device control 2
  public final static char CHAR_DC3 = 0X0013; // device control 3 (X-off)
  public final static char CHAR_DC4 = 0X0014; // device control 4
  public final static char CHAR_NAK = 0X0015; // negative acknowledge
