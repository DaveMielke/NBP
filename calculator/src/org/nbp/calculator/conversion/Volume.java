...
public class Volume extends UnitType {
  ...
  public final static double CUBIC_INCHES_PER_CUBIC_FOOT = cube(Length.INCHES_PER_FOOT);
  public final Unit CUBIC_FOOT = new Unit(CUBIC_INCH, CUBIC_INCHES_PER_CUBIC_FOOT, "cbft", "cubicfeet", "cubicfoot");

  public final static double CUBIC_FEET_PER_CUBIC_YARD = cube(Length.FEET_PER_YARD);
  public final Unit CUBIC_YARD = new Unit(CUBIC_FOOT, CUBIC_FEET_PER_CUBIC_YARD, "cbyd", "cubicyards", "cubicyard");

  public final static double CUBIC_YARDS_PER_CUBIC_ROD = cube(Length.YARDS_PER_ROD);
