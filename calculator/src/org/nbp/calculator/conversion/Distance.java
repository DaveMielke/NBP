...
public class Distance extends UnitType {
  ...
  public final Unit FURLONG = new Unit(ROD, RODS_PER_FURLONG, null, "furlongs", "furlong");
  ...
  public final Unit LEAGUE = new Unit(MILE, MILES_PER_LEAGUE, null, "leagues", "league");
}
