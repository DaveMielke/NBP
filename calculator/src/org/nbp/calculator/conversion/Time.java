...
public class Time extends UnitType {
  ...
  public final Unit SENNIGHT = new Unit(DAY, DAYS_PER_SENNIGHT, null, "sennights", "sennight");

  public final static double DAYS_PER_FORTNIGHT = 14.0;
  public final Unit FORTNIGHT = new Unit(DAY, DAYS_PER_FORTNIGHT, null, "fortnights", "fortnight");
  ...
  public final Unit DECADE = new Unit(YEAR, YEARS_PER_DECADE, null, "decades", "decade");

  public final static double YEARS_PER_CENTURY = 100.0;
  public final Unit CENTURY = new Unit(YEAR, YEARS_PER_CENTURY, null, "centuries", "century");

  public final static double YEARS_PER_MILLENNIUM = 1000.0;
  public final Unit MILLENNIUM = new Unit(YEAR, YEARS_PER_MILLENNIUM, null, "millennia", "millennium");
}
