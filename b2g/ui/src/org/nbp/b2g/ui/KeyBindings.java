...
public class KeyBindings {
  ...
  public final static char VOLUME_DOWN = '<';
  ...
  public Action getAction (int keyMask) {
    ...
    if (ApplicationParameters.DEVELOPER_ACTIONS) return action;
    return null;
  }
  ...
  private static int[] parseKeys (String operand) {
    ...
    for (int index=0; index<length; index+=1) {
      ...
      switch (Character.toUpperCase(character)) {
        ...
        case KeyBindings.VOLUME_DOWN: bit = KeyMask.VOLUME_DOWN; break;
